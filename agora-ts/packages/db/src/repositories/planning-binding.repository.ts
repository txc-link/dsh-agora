import type { IPlanningBindingRepository, PlanningBinding, PlanningBindingUpsertInput } from '@agora-ts/contracts';
  ...
  upsert(input: PlanningBindingUpsertInput): PlanningBinding {
    ...
    this.db.prepare(`
      INSERT INTO planning_bindings (
        ...
        calendar_provider, calendar_event_ref, created_at, updated_at
      ) VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?)
